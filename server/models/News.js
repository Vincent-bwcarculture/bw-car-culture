...
// Pre-save hook to generate a unique slug on new documents
newsSchema.pre('save', async function(next) {
  // Only generate when there is no slug yet (new documents).
  // Updates go through findByIdAndUpdate which bypasses this hook;
  // slug regeneration on title change is handled in the controller.
